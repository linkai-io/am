...
func (s *Service) AddWebData(ctx context.Context, userContext am.UserContext, webData *am.WebData) (int, error) {
	...
	logger := log.With().
		...
		Int("GroupID", webData.Address.GroupID).Logger()

	return userContext.GetOrgID(), nil
}

func (s *Service) addSnapshots(ctx context.Context, userContext am.UserContext, logger *zerolog.Logger, webData *am.WebData) (bool, error) {
	var tx *pgx.Tx
	var err error
