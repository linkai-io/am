...
const (
	...
	limit_tld, limit_tld_reached, limit_hosts, limit_hosts_reached, limit_custom_web_flows, limit_custom_web_flows_reached, port_scan_feature_enabled, payment_required_timestamp, billing_plan_type, billing_plan_id, billing_subscription_id, is_beta_plan`
)
...
var queryMap = map[string]string{
	...
	"orgCreate": fmt.Sprintf(`with org as (
				...
				insert into am.users (
					...
					values
						( (select org.organization_id from org), $34, $35, $36, $37, $38, $39, false) returning organization_id,user_id;`, defaultColumns),
	...
	"orgUpdate": `update am.organizations set user_pool_id=$1, user_pool_client_id=$2, user_pool_client_secret=$3, 
			...
			port_scan_feature_enabled=$25,
			payment_required_timestamp=$26, billing_plan_type=$27, billing_plan_id=$28, billing_subscription_id=$29, is_beta_plan=$30
