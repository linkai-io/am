...
var queryMap = map[string]string{
	...
	"orgCreate": fmt.Sprintf(`with org as (
				...
				insert into am.users (
					...
					values
						( (select org.organization_id from org), $22, $23, $24, $25, $26, $27, false) returning organization_id,user_id;`, defaultColumns),
	...
	"orgUpdate": `update am.organizations set user_pool_id=$1, user_pool_client_id=$2, user_pool_client_secret=$3, 
			...
			street=$12, address1=$13, address2=$14, city=$15, postal_code=$16, status_id=$17, subscription_id=$18 where organization_id=$19`,
