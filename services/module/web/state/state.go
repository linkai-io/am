...
type Stater interface {
	...
	// GetPortResults returns open ports so we don't have to waste time with using browsers to see if ports are open
	GetPortResults(ctx context.Context, orgID, scanGroupID int, host string) (*am.PortResults, error)
}
