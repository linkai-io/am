...
import (
	...
	eventprotoservice "github.com/linkai-io/am/protocservices/event"
	"github.com/linkai-io/am/protocservices/metrics"
	"github.com/linkai-io/am/services/event"
	eventprotoc "github.com/linkai-io/am/services/event/protoc"
...
func main() {
	...
	log.Logger = log.With().Str("service", "EventService").Logger()
	...
	eventp := eventprotoc.New(service, r)
	eventprotoservice.RegisterEventServer(s, eventp)
