...
type UserContext struct {
	...
	OrgStatusID          int32    `protobuf:"varint,9,opt,name=OrgStatusID,proto3" json:"OrgStatusID,omitempty"`
...
func (*UserContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_a041afaa28784997, []int{0}
}
...
func (m *UserContext) GetOrgStatusID() int32 {
	if m != nil {
		return m.OrgStatusID
	}
	return 0
}
...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_a041afaa28784997, []int{1}
}
...
func (*UserFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_a041afaa28784997, []int{2}
}
...
func (m *UserContext) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OrgStatusID != 0 {
		dAtA[i] = 0x48
		i++
		i = encodeVarintUser(dAtA, i, uint64(m.OrgStatusID))
	}
...
func (m *UserContext) Size() (n int) {
	...
	if m.OrgStatusID != 0 {
		n += 1 + sovUser(uint64(m.OrgStatusID))
	}
	if m.XXX_unrecognized != nil {
...
func (m *UserContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrgStatusID", wireType)
			}
			m.OrgStatusID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OrgStatusID |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("prototypes/user.proto", fileDescriptor_user_a041afaa28784997) }

var fileDescriptor_user_a041afaa28784997 = []byte{
	// 492 bytes of a gzipped FileDescriptorProto
	,
}
