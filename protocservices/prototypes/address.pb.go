...
type AddressData struct {
	...
	PortScanEnabled      bool     `protobuf:"varint,20,opt,name=PortScanEnabled,proto3" json:"PortScanEnabled,omitempty"`
	PortScanOverrideTLD  bool     `protobuf:"varint,21,opt,name=PortScanOverrideTLD,proto3" json:"PortScanOverrideTLD,omitempty"`
...
func (*AddressData) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_0f4f787ea04f5e45, []int{0}
}
...
func (m *AddressData) GetPortScanEnabled() bool {
	if m != nil {
...
func (m *AddressData) GetPortScanOverrideTLD() bool {
	if m != nil {
		return m.PortScanOverrideTLD
	}
	return false
}
...
func (*HostListData) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_0f4f787ea04f5e45, []int{1}
}
...
func (*ScanGroupAggregates) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_0f4f787ea04f5e45, []int{2}
}
...
func (*ScanGroupAddressStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_0f4f787ea04f5e45, []int{3}
}
...
func (*AddressFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_0f4f787ea04f5e45, []int{4}
}
...
func (m *AddressData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PortScanOverrideTLD", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PortScanOverrideTLD = bool(v != 0)
		default:
			iNdEx = preIndex
...
func init() { proto.RegisterFile("prototypes/address.proto", fileDescriptor_address_0f4f787ea04f5e45) }

var fileDescriptor_address_0f4f787ea04f5e45 = []byte{
	// 775 bytes of a gzipped FileDescriptorProto
	,
}
