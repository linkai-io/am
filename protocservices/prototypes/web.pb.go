...
func (*URLData) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{0}
}
...
func (*URLListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{1}
}
...
func (*WebData) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{2}
}
...
func (*WebCertificate) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{3}
}
...
func (*HTTPResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{4}
}
...
func (*WebSnapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{5}
}
...
func (*WebResponseFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{6}
}
...
func (*WebCertificateFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{7}
}
...
func (*WebSnapshotFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_a68c942fe91ad1a2, []int{8}
}
...
func init() { proto.RegisterFile("prototypes/web.proto", fileDescriptor_web_a68c942fe91ad1a2) }

var fileDescriptor_web_a68c942fe91ad1a2 = []byte{
	...
	,
}
