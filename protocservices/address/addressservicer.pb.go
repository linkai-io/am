...
type UpdateAddressRequest struct {
	UserContext *user.UserContext                `protobuf:"bytes,1,opt,name=UserContext" json:"UserContext,omitempty"`
	Address     map[string]*address1.AddressData `protobuf:"bytes,2,rep,name=Address" json:"Address,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *UpdateAddressRequest) GetAddress() map[string]*address1.AddressData {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *UpdateAddressRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Address == nil {
				m.Address = make(map[string]*address1.AddressData)
			}
			var mapkey string
			var mapvalue *address1.AddressData
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
