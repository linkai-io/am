...
func (GroupRequest_RequestBy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorScangroupservicer, []int{14, 0}
}
...
func (*ModuleConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptorScangroupservicer, []int{5}
}
...
func (*Group) Descriptor() ([]byte, []int) { return fileDescriptorScangroupservicer, []int{6} }
...
func (*ScanGroupFilter) Descriptor() ([]byte, []int) { return fileDescriptorScangroupservicer, []int{7} }
...
func (*NewGroupRequest) Descriptor() ([]byte, []int) { return fileDescriptorScangroupservicer, []int{8} }
...
func (*GroupRequest) Descriptor() ([]byte, []int) { return fileDescriptorScangroupservicer, []int{14} }
...
func (m *AllGroupsRequest) GetUserContext() *user.UserContext {
	if m != nil {
		return m.UserContext
	}
	return nil
...
func (*GroupsRequest) Descriptor() ([]byte, []int) { return fileDescriptorScangroupservicer, []int{17} }
...
func (*GroupResponse) Descriptor() ([]byte, []int) { return fileDescriptorScangroupservicer, []int{18} }
...
func (c *scanGroupClient) AllGroups(ctx context.Context, in *AllGroupsRequest, opts ...grpc.CallOption) (ScanGroup_AllGroupsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ScanGroup_serviceDesc.Streams[0], c.cc, "/scangroup.ScanGroup/AllGroups", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *scanGroupClient) Groups(ctx context.Context, in *GroupsRequest, opts ...grpc.CallOption) (ScanGroup_GroupsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ScanGroup_serviceDesc.Streams[1], c.cc, "/scangroup.ScanGroup/Groups", opts...)
	if err != nil {
		return nil, err
	}
