...
func (*AnalyzeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_moduleservicer_16e7b5155a1c34ac, []int{0}
}
...
func (*AnalyzedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_moduleservicer_16e7b5155a1c34ac, []int{1}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]*prototypes.AddressData)(nil), "module.AnalyzedResponse.AddressesEntry")
}
...
func (c *moduleClient) Analyze(ctx context.Context, in *AnalyzeRequest, opts ...grpc.CallOption) (*AnalyzedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/module.Module/Analyze", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("module/moduleservicer.proto", fileDescriptor_moduleservicer_16e7b5155a1c34ac)
}

var fileDescriptor_moduleservicer_16e7b5155a1c34ac = []byte{
